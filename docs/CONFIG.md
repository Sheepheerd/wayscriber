...
# This is a render setting, so it restyles existing strokes too.
marker_glow = 0.0

# Corner radius in pixels for newly pasted images (0 = square corners).
# Adjust an existing image from the selection properties panel (Ctrl+Alt+P).
